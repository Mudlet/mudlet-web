...
Mudlet Web has no *Special Options* tab and doesn't need one. That Mudlet tab holds
five controls; the first, "Force compression off", is already Mudlet Web's positive
...
connect" hint (Mudlet Web's equivalent of `need_reconnect_for_specialoption`).

| Key | Mudlet Web tab | Mudlet home |
|---|---|---|
